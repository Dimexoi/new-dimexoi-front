...
//   store.dispatch(setAllCategories(allCategories));

  
//   store.dispatch(setSomeSdbProducts(displayedSdbProducts));

//   store.dispatch(setAllCollections(allCollections));

//   return {
//     props: {
//       allCategories,
//       displayedSdbProducts,
//       allCollections
//     },
//     revalidate: 60
//   };
